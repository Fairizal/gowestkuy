                ...
                <div class="row push">
                    <div class="col-lg-12 col-xl-5">
                        ...
                        <div class="form-group">
                            ...
                            <select class="js-select2 form-control" id="type" name="type" style="width: 100%;" data-placeholder="Pilih Tipe" disabled>
                        ...
                        <div class="form-group">
                            ...
                            <select class="js-select2 form-control" id="merk" name="merk" style="width: 100%;" data-placeholder="Pilih Merk" disabled>
                                <option></option><!-- Required for data-placeholder attribute to work with Select2 plugin -->
                                <?php
